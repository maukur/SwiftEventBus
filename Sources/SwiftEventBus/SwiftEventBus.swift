//Special thanks César Ferreira from Artem Tishchenko
...
open class SwiftEventBus {
    ...
    struct Static {
        ...
        static let queue = DispatchQueue(label: "com.artemtishchenko.swifteventbus", attributes: [])
    }
    ...
    @discardableResult
    open class func on(_ target: AnyObject,
                       name: String,
                       sender: Any? = nil,
    ...
    @discardableResult
    open class func onMainThread(_ target: AnyObject,
                                 name: String,
                                 sender: Any? = nil,
                                 handler: @escaping ((Notification?) -> Void)) -> NSObjectProtocol {
    ...
    @discardableResult
    open class func onBackgroundThread(_ target: AnyObject,
                                       name: String,
                                       sender: Any? = nil,
                                       handler: @escaping ((Notification?) -> Void)) -> NSObjectProtocol {
